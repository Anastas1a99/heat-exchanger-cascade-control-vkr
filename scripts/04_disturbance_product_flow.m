% Моделирование возмущения по расходу продукта
...
x1 = 200;                 % левая граница графиков, с
x2 = 600;                 % правая граница графиков, с
...
set_param([mdl '/ΔG_продукта'], 'Before', '0', 'After', '1.2');
set_param([mdl '/ΔT_вх'],       'Before', '0', 'After', '0');
...
%% 7. Расчёт показателей расхода пара
...
%% 8. Расчёт показателей управляющего сигнала
...
fprintf('\n============================================================\n');
fprintf('ВОЗМУЩЕНИЕ ПО РАСХОДУ ПРОДУКТА\n');
fprintf('============================================================\n');
...
fprintf('\nРасход пара:\n');
fprintf('Исходный расход G0 = %.4f кг/с\n', G0);
fprintf('Максимальный расход Gmax = %.4f кг/с\n', Gmax);

fprintf('\nУправляющий сигнал:\n');
fprintf('Исходное открытие клапана U0 = %.2f %%\n', U0);
fprintf('Максимальное открытие клапана Umax = %.2f %%\n', Umax);
...
exportgraphics(gcf, 'ris_3_4_product_flow_temperature.png', ...
    'Resolution', 300);

%% 11. График расхода пара
...
legend({'Фактический расход пара', 'Исходный уровень', ...
        'Момент возмущения', 'Максимум расхода'}, ...
    'Location', 'best', ...
    'FontSize', 13);
...
text(t_gmax + 5, Gmax + 0.002, ...
    sprintf('Максимум = %.3f кг/с', Gmax), ...
    'FontSize', 13);

exportgraphics(gcf, 'ris_3_5_product_flow_steam_flow.png', ...
    'Resolution', 300);

%% 12. График управляющего сигнала
...
legend({'Управляющий сигнал', 'Исходный уровень', ...
        'Момент возмущения', 'Максимум сигнала'}, ...
    'Location', 'best', ...
    'FontSize', 13);
...
text(t_umax + 5, Umax + 0.1, ...
    sprintf('Максимум = %.2f %%', Umax), ...
    'FontSize', 13);

exportgraphics(gcf, 'ris_3_6_product_flow_valve_signal.png', ...
    'Resolution', 300);
