% Моделирование возмущения по параметрам греющего пара
...
set_param([mdl '/ΔT_пара'],     'Before', '0', 'After', '-4');
...
fprintf('\n============================================================\n');
fprintf('ВОЗМУЩЕНИЕ ПО ПАРАМЕТРАМ ГРЕЮЩЕГО ПАРА\n');
fprintf('============================================================\n');
...
exportgraphics(gcf, 'ris_3_10_steam_pressure_temperature.png', ...
    'Resolution', 300);
...
text(t_umax + 5, Umax + 0.05, ...
    sprintf('Максимальное открытие = %.2f %%', Umax), ...
    'FontSize', 13);

exportgraphics(gcf, 'ris_3_11_steam_pressure_valve_signal.png', ...
    'Resolution', 300);
...
text(t_gmax + 5, Gmax + 0.001, ...
    sprintf('Максимальный расход = %.3f кг/с', Gmax), ...
    'FontSize', 13);

exportgraphics(gcf, 'ris_3_12_steam_pressure_steam_flow.png', ...
    'Resolution', 300);
